...
<section class="fundraiser">
   ...
   <h1 class="title">fundraiser categories</h1>

   <div class="box-container">

   <?php
      $category_name = $_GET['category'];
      $select_fundraiser = $conn->prepare("SELECT * FROM `fundraiser` WHERE category = ?");
      $select_fundraiser->execute([$category_name]);
   ...
   <?php
         ...
         echo '<p class="empty">no fundraiser available!</p>';
      }
   ?>
