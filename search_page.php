...
<section class="search-form">
   ...
   <form action="" method="POST">
      <input type="text" class="box" name="search_box" placeholder="search fundraiser...">
...
<?php
?>
<section class="fundraiser" style="padding-top: 0; min-height:100vh;">
   ...
   <?php
      ...
      $select_fundraiser = $conn->prepare("SELECT * FROM `fundraiser` WHERE name LIKE '%{$search_box}%' OR category LIKE '%{$search_box}%'");
