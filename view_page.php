...
<section class="quick-view">
   ...
   <form action="" class="box" method="POST">
      ...
      <h1>FUNDRAISER IMAGE</h1>
      <img src="uploaded_img/<?= $fetch_fundraiser['image']; ?>" alt="">
      <div class="name"><?= $fetch_fundraiser['name']; ?></div>
      <div class="phoneno"><?= $fetch_fundraiser['phoneno']; ?></div>
      <div class="issue"><?= $fetch_fundraiser['issue']; ?></div>
     
      <h1>VERIFY DOCUMENT</h1>
      <div class="image2"><?= $fetch_fundraiser['image2']; ?></div>
      <img src="uploaded_img2/<?= $fetch_fundraiser['image2']; ?>" alt="">
      <H1>ADDRESS</H1>
      <div class="address"><?= $fetch_fundraiser['address']; ?></div>
      <H1>MORE DETAILS</H1>
      ...
      <input type="hidden" name="f_image2" value="<?= $fetch_fundraiser['image2']; ?>">
      <BR>
